...
conda activate /esat/smcdata/users/kkontras/Image_Dataset/no_backup/envs/ec_p10

which python
python -V
cd /users/sista/kkontras/Documents/Epilepsy_Challenge/irregulars_neureka_codebase
echo $PWD
